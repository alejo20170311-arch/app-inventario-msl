...
create policy "colaboradores admin y gh modifican"
on public.colaboradores
for all
to authenticated
using (public.rol_usuario() in ('Administrador', 'Gestion Humana'))
with check (public.rol_usuario() in ('Administrador', 'Gestion Humana'));
...
create policy "comprobantes admin y gh modifican"
on public.comprobantes
for all
to authenticated
using (public.rol_usuario() in ('Administrador', 'Gestion Humana'))
...
create policy "entregas admin y gh modifican"
on public.entregas
for all
to authenticated
using (public.rol_usuario() in ('Administrador', 'Gestion Humana'))
...
create policy "movimientos admin bodega gh modifican"
on public.movimientos
for all
to authenticated
using (public.rol_usuario() in ('Administrador', 'Bodega', 'Gestion Humana'))
with check (public.rol_usuario() in ('Administrador', 'Bodega', 'Gestion Humana'));
...
create policy "auditoria insercion autenticados"
on public.auditoria
for insert
to authenticated
