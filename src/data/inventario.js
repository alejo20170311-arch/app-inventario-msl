...
export const catalogoProductosBase = [
  ...
  { categoria: "EPP", nombre: "Casco en trabajo en alturas", tipo: "Trabajo en alturas", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Gafas de seguridad", tipo: "Protección visual", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Careta Esmerilar", tipo: "Protección facial", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Visor de seguridad", tipo: "Protección facial", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Tapaoidos", tipo: "Protección auditiva", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Mascara Respirador Media Cara", tipo: "Protección respiratoria", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Filtros mascara media cara", tipo: "Protección respiratoria", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Tapabocas N95", tipo: "Protección respiratoria", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Tapabocas negro quirurgico", tipo: "Protección respiratoria", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Traje en PVC", tipo: "Protección corporal", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Peto de carnaza", tipo: "Protección corporal", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Delantal Industrial PVC", tipo: "Protección corporal", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Guantes de lavanderia medio brazo", tipo: "Protección manos", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Trajes Tyvec", tipo: "Protección corporal", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Guantes de carnaza", tipo: "Protección manos", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Guantes de nitrilo", tipo: "Protección manos", unidad: "Caja", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Guantes de tela", tipo: "Protección manos", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Guantes para calor", tipo: "Protección manos", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Guantes dieléctricos", tipo: "Protección manos", unidad: "Par", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Canguros (mantenimiento)", tipo: "Mantenimiento", unidad: "Unidad", variantes: ["Única"] },
  { categoria: "EPP", nombre: "Tapaoidos tipo copa", tipo: "Protección auditiva", unidad: "Unidad", variantes: ["Única"] },
]
